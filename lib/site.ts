 ...
 *
 * Вес 500. Чертёж требует жирное, и у Playpen Sans оно настоящее,
 * а не подрисованное браузером, — но и 700, и 600 на пластине выходили
 * плотнее гравировки. Гарнитура переменная, ступень выбрана по сверке
 * с фотографией партии.
 */
export const FONTS = [
  {
    id: "print",
