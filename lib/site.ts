 ...
 *
 * Вес 600. Чертёж требует жирное, и у Playpen Sans оно настоящее,
 * а не подрисованное браузером, — но 700 на пластине оказалось плотнее
 * гравировки. Гарнитура переменная, поэтому берём промежуточную ступень,
 * а не ближайшую стандартную.
 */
export const FONTS = [
  {
    id: "print",
