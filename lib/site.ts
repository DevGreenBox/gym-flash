 ...
 *
 * Вес 700 — чертёж требует жирное начертание. У Playpen Sans оно
 * настоящее, а не подрисованное браузером: у прежней Neucha был один
 * вес, и на пластине она выходила заметно жиже гравировки.
 */
export const FONTS = [
  {
    id: "print",
