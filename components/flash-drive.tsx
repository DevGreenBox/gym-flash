...
/**
 * Левая граница надписи — не край поля гравировки, а отступ с изделия.
 *
 * По чертежу поле начинается в 2,5 мм от торца, но там ещё идёт
 * скруглённый нос оболочки, и на фотографии партии «Ч» стоит примерно
 * в 5,4 мм от торца. Берём число с изделия.
 *
 ...
 */
const ЛЕВЫЙ_КРАЙ = Math.max(FIELD_L, ОТСТУП_НАДПИСИ);
